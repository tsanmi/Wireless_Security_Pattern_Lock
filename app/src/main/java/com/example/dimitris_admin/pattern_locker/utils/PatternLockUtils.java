...
//klasi i opoia periexete sto paketo utills tou etoimou kwdika
//kai einai to meso "epikoinwnias" me tin main klasi
...
public class PatternLockUtils {
    ...
    //eisagwgi dikwn mou klasewn gia na pairnw ta dedomena pou xreiazomai
    //opws tis arraylist me ta x,y, tis pieseis

    public static float getX(PatternLockView patternLockView)

    {
        float flag = 0;
        if (patternLockView.Xpoints.size() != 0) {
            flag = patternLockView.Xpoints.get(patternLockView.Xpoints.size() - 1);
        }

        return flag;
    }

    public static float getY(PatternLockView patternLockView) {
        float flag = 0;
        if (patternLockView.Ypoints.size() != 0) {
            flag = patternLockView.Ypoints.get(patternLockView.Ypoints.size() - 1);
        }

        return flag;
    }

    public static ArrayList<Float> getXpoints(PatternLockView patternLockView) {
        return patternLockView.Xpoints;
    }

    public static ArrayList<Float> getYpoints(PatternLockView patternLockView) {
        return patternLockView.Ypoints;
    }


    public static float getPre(PatternLockView patternLockView) {
        float flag = 0;

        if (patternLockView.presure.size() != 0) {
            flag = patternLockView.presure.get(patternLockView.presure.size()-1);
        }

        return flag;

    }
    public static  ArrayList<Float> getArrayPre(PatternLockView patternLockView)
    {return patternLockView.presure;}

    public static long getTime(PatternLockView patternLockView) {
        long flag = 0;
        if (patternLockView.total != 0) {
            flag = patternLockView.total;
        }
        return flag;
    ...
    public static HashMap getMap(PatternLockView patternLockView) {
        HashMap map = patternLockView.getTheMap();
        return map;
    }
